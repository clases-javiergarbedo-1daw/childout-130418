...
public class PersonaAutorizada extends javax.swing.JPanel {
    ...
    ArrayList<Alumno> listaAlumnosSeleccionada = null;
    ArrayList<Alumno> listaAlumnosAgregada = null;

    public PersonaAutorizada() {
        initComponents();
        if (!java.beans.Beans.isDesignTime()) {

            listaAlumnosSeleccionada = null;
            listaAlumnosAgregada = new ArrayList();
    ...
    private void initComponents() {
        ...
        jButton5.setText("Recoger firma");

        jButton6.setText("Recoger foto");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (!jList1.isSelectionEmpty()) {
            ...
            if (index != -1) {
                ...
                int id_alumno = al.getId_alumno();
                for (int j = 0; j < listaAlumnosAgregada.size(); j++) {
                    if (id_alumno == listaAlumnosAgregada.get(j).getId_alumno()) {
                        comprobar = true;
                        JOptionPane.showMessageDialog(jComboBox1, "Ya ha sido agregado el alumno ", "Error", JOptionPane.ERROR_MESSAGE);
                    }
                }
                if (comprobar == false) {
                    listaAlumnosAgregada.add(al);

                    for (int i = 0; i < listaAlumnosAgregada.size(); i++) {
                        String nombreApellidos = listaAlumnosAgregada.get(i).getNombre();
                        listModel.add(i, nombreApellidos);
                    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (index != -1) {
            al = listaAlumnosAgregada.get(index);
            listaAlumnosAgregada.remove(index);
            for (int i = 0; i < listaAlumnosAgregada.size(); i++) {
                String nombreApellidos = listaAlumnosAgregada.get(i).getNombre();
                listModel.add(i, nombreApellidos);
            }
